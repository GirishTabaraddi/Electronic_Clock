// ======================================================================
// Assignment2.v generated from TopDesign.cysch
// 07/23/2023 at 17:48
...
module top ;
	...
	wire [0:0] tmpOE__KeyLeft_Button_3_net;
	wire [0:0] tmpFB_0__KeyLeft_Button_3_net;
	wire [0:0] tmpIO_0__KeyLeft_Button_3_net;
	wire [0:0] tmpINTERRUPT_0__KeyLeft_Button_3_net;
	electrical [0:0] tmpSIOVREF__KeyLeft_Button_3_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		KeyLeft_Button_3
		 (.oe(tmpOE__KeyLeft_Button_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__KeyLeft_Button_3_net[0:0]}),
		  .io({tmpIO_0__KeyLeft_Button_3_net[0:0]}),
		  .siovref(tmpSIOVREF__KeyLeft_Button_3_net),
		  .interrupt({tmpINTERRUPT_0__KeyLeft_Button_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__KeyLeft_Button_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__KeyRight_Button_4_net;
	wire [0:0] tmpFB_0__KeyRight_Button_4_net;
	wire [0:0] tmpIO_0__KeyRight_Button_4_net;
	wire [0:0] tmpINTERRUPT_0__KeyRight_Button_4_net;
	electrical [0:0] tmpSIOVREF__KeyRight_Button_4_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4e41b9f7-89eb-4e78-91d8-58545d1b6406"),
		  ...
		  .input_buffer_sel(2'b00))
		KeyRight_Button_4
		 (.oe(tmpOE__KeyRight_Button_4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__KeyRight_Button_4_net[0:0]}),
		  .io({tmpIO_0__KeyRight_Button_4_net[0:0]}),
		  .siovref(tmpSIOVREF__KeyRight_Button_4_net),
		  .interrupt({tmpINTERRUPT_0__KeyRight_Button_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__KeyRight_Button_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
