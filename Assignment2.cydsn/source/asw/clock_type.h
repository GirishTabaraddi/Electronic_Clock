...
typedef enum 
{
  ...
  CLOCK_C_ISDISPLAYING,         /**< Clock Container Displaying State. */
  CLOCK_C_ISEDITINGHOURS,       /**< Clock Container Hour editing State. */
  CLOCK_C_ISEDITINGMINUTES,     /**< Clock Container Minutes editing State. */
    
  CLOCK_W_ISDISPLAYING,         /**< Clock Widget Displaying State. */
  CLOCK_W_ISEDITING,            /**< Clock Widget editing State. */
  CLOCK_W_ISAUTOINCREMENT       /**< Clock Widget Auto Increment State. */
...
typedef struct eCLOCK_display CLOCK_display_t;
...
//void ProcessEvent(STATE_state_t *state, STATE_event_t event);
